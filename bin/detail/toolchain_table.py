...
if platform.system() == 'Darwin':
  toolchain_table += [
      ...
      Toolchain('ios-nocodesign-dep-11-0', 'Xcode', nocodesign=True),
      ...
      Toolchain('ios-nocodesign-11-3-dep-11-0', 'Xcode', ios_version='11.3', nocodesign=True),
      ...
      Toolchain('ios-nocodesign-11-4-dep-11-0', 'Xcode', ios_version='11.4', nocodesign=True),
